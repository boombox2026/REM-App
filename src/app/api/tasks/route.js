...
export async function POST(request) {
  try {
    ...
    // الاعتماد بالكامل على الذكاء الاصطناعي فقط
    ...
    // في حالة الخطأ، مفيش طوارئ هتخرف، هيرجع رسالة خطأ صريحة
    return NextResponse.json({ success: false, error: "عفواً، المساعد الذكي غير متاح حالياً. حاول مرة أخرى." }, { status: 500 });
  }
}
